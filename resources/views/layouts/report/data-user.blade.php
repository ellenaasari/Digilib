        ...
        <div id="main" class="pt-xl-0 pt-sm-3 mt-0 ml-1 px-4">
            <div class="row">
                <div class="col-6 order-md-1">
                    <div class="m-0 pt-2 ">
                        <h3 class="m-0 p-0 text-white">Profile Member</h3>
                        <p class="text-white-50">Data pribadi {{ $user->name }}</p>
                    </div>
                </div>
                ...
                <div class="card-body pt-3">
                    ...
                    <div class="tab-content pt-2">
                        <div class="tab-pane fade show active profile-overview" id="profile-overview" role="tabpanel">
                            ...
                            <hr>
                            <h5 class="card-title">Tentang Dia</h5>
                            <p class="small fst-italic">Dia meminjam buku di Perpustakaan sebanyak
                                {{ $totalPinjam[0]->total }} kali.</p>
                        ...
                        <div class="tab-pane fade profile-edit pt-3" id="profile-edit" role="tabpanel">
                            <form action="{{ route('update-user', ['id' => $user]) }}" method="POST"
